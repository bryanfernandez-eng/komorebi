    ...
    <div className="min-h-[calc(100vh-120px)] bg-[#FBF7EC] p-6">
      <div className="max-w-2xl mx-auto space-y-4">
        ...
        <div className="bg-white border border-[#D1CAA9] rounded-2xl overflow-hidden shadow-sm">
          ...
          <div className="p-5">
            <p className="text-[11px] text-[#B69265] mb-4">Raw data from your daily check-ins — the input the Signal Agent analyses.</p>
              ...
              {history.length > 0 ? (
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart data={history} margin={{ top: 5, right: 5, left: -20, bottom: 0 }}>
                    ...
                    <Tooltip
                      contentStyle={{ backgroundColor: '#FBF7EC', border: '1px solid #D1CAA9', borderRadius: '8px', fontSize: '12px' }}
                      itemStyle={{ padding: '2px 0' }}
                      labelStyle={{ color: '#4E6E4C', marginBottom: '4px' }}
                    />
                    <Line type="monotone" dataKey="mood"   name="Mood"   stroke="#A8C99A" strokeWidth={2} dot={{ fill: '#FBF7EC', stroke: '#A8C99A', strokeWidth: 2, r: 3 }} activeDot={{ r: 4 }} />
                    <Line type="monotone" dataKey="sleep"  name="Sleep"  stroke="#4E6E4C" strokeWidth={2} dot={{ fill: '#FBF7EC', stroke: '#4E6E4C', strokeWidth: 2, r: 3 }} activeDot={{ r: 4 }} />
                    <Line type="monotone" dataKey="stress" name="Stress" stroke="#594031" strokeWidth={2} dot={{ fill: '#FBF7EC', stroke: '#594031', strokeWidth: 2, r: 3 }} activeDot={{ r: 4 }} />
                  </LineChart>
                </ResponsiveContainer>
              ) : (
