    ...
    <div className="min-h-screen bg-[#FBF7EC] flex items-center justify-center p-6">
      <div className="w-full max-w-sm space-y-8">
        ...
        <div className="text-center space-y-3">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-[#D1CAA9] border border-[#B69265] mb-1">
            <svg width="24" height="24" viewBox="0 0 22 22" fill="none">
              ...
              <line x1="4.93" y1="4.93"   x2="7.35" y2="7.35"   stroke="#304E2F" strokeWidth="1.5" strokeLinecap="round" opacity="0.35"/>
              <line x1="14.65" y1="14.65" x2="17.07" y2="17.07" stroke="#304E2F" strokeWidth="1.5" strokeLinecap="round" opacity="0.35"/>
              <line x1="17.07" y1="4.93"  x2="14.65" y2="7.35"  stroke="#304E2F" strokeWidth="1.5" strokeLinecap="round" opacity="0.35"/>
              <line x1="7.35" y1="14.65"  x2="4.93" y2="17.07"  stroke="#304E2F" strokeWidth="1.5" strokeLinecap="round" opacity="0.35"/>
            </svg>
          </div>
          <h1 className="text-2xl font-bold text-[#304E2F]">Komorebi</h1>
          <p className="text-[14px] text-[#4E6E4C] leading-relaxed">
        ...
        <div className="grid grid-cols-3 gap-3">
          {[
            ...
            <div key={step} className="bg-[#D1CAA9] border border-[#B69265] rounded-xl p-3 text-center opacity-90">
              <div className="text-xl mb-1">{icon}</div>
              <div className="text-[12px] font-semibold text-[#304E2F]">{label}</div>
              <div className="text-[10px] text-[#4E6E4C] mt-0.5">{sub}</div>
            </div>
          ))}
        </div>
        ...
        <div className="space-y-2">
          <p className="text-[11px] font-semibold tracking-[0.08em] uppercase text-[#594031] mb-3">
          ...
          {PROFILES.map(profile => (
            <button
              ...
              style={{
                backgroundColor: hovered === profile.id ? '#A8C99A' : '#D1CAA9',
                border: `1px solid ${hovered === profile.id ? '#4E6E4C' : '#B69265'}`,
              }}
            >
              <div
              ...
              <div className="flex-1 min-w-0">
                <div className="text-[14px] font-bold text-[#304E2F]">{profile.name}</div>
                <div className="text-[11px] font-medium text-[#4E6E4C] mt-0.5">
              ...
              <svg width="14" height="14" viewBox="0 0 14 14" fill="none"
                style={{ opacity: hovered === profile.id ? 0.8 : 0.4, transition: 'opacity 0.15s' }}>
                <path d="M3 7h8M7 3l4 4-4 4" stroke="#304E2F" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            </button>
          ))}
        </div>

        <p className="text-center text-[11px] font-semibold text-[#B69265]">
