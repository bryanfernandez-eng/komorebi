            ...
            try:
                ...
                if action_taken == "full_outreach":
                    ...
                    resp_en = client.models.generate_content(
                        model="gemini-1.5-flash", contents=prompt_en
                    )
                    ...
                    resp_es = client.models.generate_content(
                        model="gemini-1.5-flash", contents=prompt_es
                    )
                    ...
                    resp_en = client.models.generate_content(
                        model="gemini-1.5-flash", contents=nudge_prompt_en
                    )
                    message_en = resp_en.text.strip()
                    ...
                    resp_es = client.models.generate_content(
                        model="gemini-1.5-flash", contents=nudge_prompt_es
                    )
                    message_es = resp_es.text.strip()
                ...
                resp_pred = client.models.generate_content(
                    model="gemini-1.5-flash", contents=pred_prompt
                )
